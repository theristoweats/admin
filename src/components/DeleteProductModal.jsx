...
const DeleteProductModal = ({productDeleteId, setProductDeleteId}) =>{ 
    ...
    const handleDeleteYes = (e) =>{
        e.preventDefault();
        deleteProduct(productDeleteId, setProductDeleteId, dispatch);
    }
    ...
    return (
        <>
            ...
            <Modal>
                <InsideModalAsk>
                    <InsideModalAskPro>
                        <MainTextModal>Вниманије! Ќе го избришете производот.</MainTextModal>
                        <SecoundText>Дали сте сигурни дека сакате да го избришете производот?</SecoundText>   
                        <ButtonsLoadHere>
                            <SingleButton>
