...
import { addCategory, addProduct, updateCategory } from "../redux/apiCalls";
...
const DashboardCategory = () =>{
    ...
    const onSubmit = async e => {
        ...
        try {
            ...
            updateCategory(id, category, dispatch, navigate);
        }catch(err){
            console.log(err);
        }
    }
    ...
    return (<>
        <DashboardProductsRight>
            ...
            <NewProductAdd>
                <TextNewProduct>Измени категорија</TextNewProduct>
                ...
                <InputEtc>
                    <form onSubmit={onSubmit}> 
                        ...
                        <SingleInputText>
                            ...
                            <Input 
                                type="text" 
                                placeholder={category.category_url}
                                name="category_url"
                                onChange={handleChange} />
                        </SingleInputText>  
