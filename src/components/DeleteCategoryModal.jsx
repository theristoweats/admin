...
import { deleteCategory, deleteProduct } from "../redux/apiCalls";
...
const DeleteCategoryModal = ({categoryDeleteId, setCategoryDeleteId}) =>{ 
    ...
    const handleDeleteYes = (e) =>{
        e.preventDefault();
        deleteCategory(categoryDeleteId, setCategoryDeleteId, dispatch);
    }
    ...
    return (
        <>
            ...
            <Modal>
                <InsideModalAsk>
                    <InsideModalAskPro>
                        <MainTextModal>Вниманије! Ќе ја избришете категоријата.</MainTextModal>
                        <SecoundText>Дали сте сигурни дека сакате да ја избришете категоријата?</SecoundText>   
                        <ButtonsLoadHere>
                            <SingleButton>
