...
const DeleteUserModal = ({userDeleteId, setUserDeleteId}) =>{ 
    ...
    const handleDeleteYes = (e) =>{
        e.preventDefault();
        deleteUser(userDeleteId, setUserDeleteId, dispatch);
    }
    ...
    return (
        <>
            ...
            <Modal>
                <InsideModalAsk>
                    <InsideModalAskPro>
                        <MainTextModal>Вниманије! Ќе го избришете корисникот.</MainTextModal>
                        <SecoundText>Дали сте сигурни дека сакате да го избришете корисникот?</SecoundText>   
                        <ButtonsLoadHere>
                            <SingleButton>
