...
import { deleteCarrier, deleteCategory, deleteProduct } from "../redux/apiCalls";
...
const DeleteCarrierModal = ({carrierDeleteId, setCarrierDeleteId}) =>{ 
    ...
    const handleDeleteYes = (e) =>{
        e.preventDefault();
        deleteCarrier(carrierDeleteId, setCarrierDeleteId, dispatch);
    }
    ...
    return (
        <>
            ...
            <Modal>
                <InsideModalAsk>
                    <InsideModalAskPro>
                        <MainTextModal>Вниманије! Ќе го избришете доставувачот.</MainTextModal>
                        <SecoundText>Дали сте сигурни дека сакате да го избришете доставувачот?</SecoundText>   
                        <ButtonsLoadHere>
                            <SingleButton>
